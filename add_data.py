...
with app.app_context():
    ...
    sample_products = [
        Product(name="AMD Ryzen 5 5600", category="CPU", brand="AMD", price=11500,
                ...
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/AMD_Ryzen_5000_Series_CPU.jpg/300px-AMD_Ryzen_5000_Series_CPU.jpg"),
        Product(name="Intel Core i5-12400F", category="CPU", brand="Intel", price=13500,
                stock=8, socket_type="LGA1700", wattage=65,
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Intel_Core_i5_CPU.jpg/300px-Intel_Core_i5_CPU.jpg"),
        ...
        Product(name="MSI B450M-A PRO MAX", category="Motherboard", brand="MSI", price=6500,
                ...
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Motherboard_diagram.svg/300px-Motherboard_diagram.svg.png"),
        ...
        Product(name="Corsair Vengeance 16GB DDR4 3200MHz", category="RAM", brand="Corsair",
                ...
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/DDR4_SDRAM_module.jpg/300px-DDR4_SDRAM_module.jpg"),
        ...
        Product(name="NVIDIA RTX 4060", category="GPU", brand="NVIDIA", price=32000,
                stock=4, wattage=115,
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/NVIDIA_GeForce_RTX_graphics_card.jpg/300px-NVIDIA_GeForce_RTX_graphics_card.jpg"),
        ...
        Product(name="Corsair 650W 80+ Bronze", category="PSU", brand="Corsair", price=4500,
                ...
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/ATX_Power_supply.jpg/300px-ATX_Power_supply.jpg"),
        ...
        Product(name="Samsung 970 EVO 500GB NVMe SSD", category="Storage", brand="Samsung",
                price=3800, stock=12,
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/NVMe_SSD.jpg/300px-NVMe_SSD.jpg"),
        Product(name="Seagate Barracuda 1TB HDD", category="Storage", brand="Seagate",
                price=2800, stock=20,
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Hard_disk_drive.jpg/300px-Hard_disk_drive.jpg"),

        Product(name="NZXT H510", category="Case", brand="NZXT", price=5500,
                stock=6, form_factor="ATX",
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Computer_case.jpg/300px-Computer_case.jpg"),
